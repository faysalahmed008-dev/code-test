			...
			<div class="zerogrid">
				...
				<div class="t-center">
					<a class="site-branding" href="index.html">
						<img src="images/logo 3.JPG" width="300px"/>	
					</a><!-- .site-branding -->
					...
					<div id='cssmenu' class="align-center">
						<ul>
						   ...
						   <li class=' has-sub'><a href='#'><span>Categories</span></a>
							  <ul >
								 <li class='has-sub'><a href='#'><span>Digital Renaissance</span></a></li>
								 <li class='has-sub'><a href='#'><span>Mystry Bloom</span></a></li>
							  </ul>
						   </li>
			...
			<div class="zerogrid wrap-footer">
				<div class="row">
					<div class="bottom-social">
						<a href="https://twitter.com/faysal_7cyrus"><i class="fa fa-twitter"></i></a>
						<a href="https://opensea.io/7cyrus"><i class="fa fa-opensea"></i></a>
						<a href="https://rarible.com/7cyrus/"><i class="fa fa-rarible"></i></a>
					</div>
				</div>
				<div class="copyright">
					Copyright @ - Designed by <a href="https://www.facebook.com/m.faysalarnob">FAYSAL</a>
				</div>
			</div>
		</footer>
